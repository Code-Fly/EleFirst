$(document).ready(function () {
    ...
    DateBoxUtils.initMonthBox($("#datebox-time"));
    ...
    $("#btn-detail-export").linkbutton({
        onClick: function () {
            var startDate = TimeUtils.dataBoxMonthToDate($("#datebox-time").datebox("getValue"));
            var endDate = TimeUtils.dataBoxMonthToDate($("#datebox-time").datebox("getValue"));
            ...
            window.location.href = _ctx + "report/t003/monthly/export.do?" + param;
        }
    });
    ...
    function loadData() {
        ...
        $("#tt2").datagrid({
            url: _ctx + "report/t003/monthly/list.do",
            queryParams: {
                areaId: _areaId,
                startTime: startDate.format("yyyyMMddhhmmss"),
                endTime: endDate.format("yyyyMMddhhmmss"),
