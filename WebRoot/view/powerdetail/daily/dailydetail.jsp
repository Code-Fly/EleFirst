        ...
        <div title="功率因数" style="display:none;overflow: hidden">
            <table id="tt5" class="easyui-datagrid" fit="true" data-options="border:false">
                ...
                <tr>
                    ...
                    <%--<th rowspan="2" field="concentratorId" width="80" align="center">集中器</th>--%>
                    <%--<th rowspan="2" field="pn" width="80" align="center">监测点</th>--%>
                    <th rowspan="2" field="amaxpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="bmaxpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="cmaxpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="maxtotalpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="mintotalpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="aminpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="bminpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="cminpowerfactor" hidden="true"></th>
                    <th rowspan="2" field="name" width="200" align="center">监测点</th>
                    <th rowspan="2" field="days" width="120" align="center" formatter="dateformatter">日期</th>
