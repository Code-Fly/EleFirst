...
<div data-options="region:'center',border:false" style="width:100%;overflow: hidden">
    ...
    <div id="tt" class="easyui-tabs" data-options="border:false,tools:'#tab-tt-tools'" fit="true">
        ...
        <%--</tr>--%>
        <%--<tr>--%>
        <%--<th field="1" width="80" align="center" data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 3)}">总</th>--%>
        <%--<th field="2" width="80" align="center" data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 3)}">峰</th>--%>
        <%--<th field="3" width="80" align="center" data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 3)}">平</th>--%>
        <%--<th field="4" width="80" align="center" data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 3)}">谷</th>--%>
        <%--<th field="5" width="80" align="center" data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 3)}">尖峰</th>--%>
        <%--<th field="6" width="80" align="center" data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 3)}">最大需量</th>--%>
        ...
        <div title="功率因数" style="display:none;overflow: hidden">
            <table id="tt5" style="display:none">
                ...
                <tr>
                    <th field="powerFactorStandard" width="120" align="center"
                        data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 1)}">
                        标准
                    </th>
                    <th field="avgtotalpowerfactor" width="120" align="center"
                        data-options="formatter:function(value){return DataGridUtils.floatFormatter(value, 1)}">
                        功率因素
                    </th>
                </tr>
