...
public class DataF25FrozenMinuteDAO extends BaseDAO implements IDataF25FrozenMinuteDAO {
    ...
    @Override
    public List<DataF25FrozenMinuteWithF5> getDataF25FrozenMinuteStatisticsWithF5DailyList(DataF25FrozenMinuteExample example) {
        return dataF25FrozenMinuteCustomMapper.selectStatisticsWithF5DailyByExample(example);
    }

    @Override
    public List<DataF25FrozenMinuteWithF21> getDataF25FrozenMinuteStatisticsWithF21MonthlyList(DataF25FrozenMinuteExample example) {
        return dataF25FrozenMinuteCustomMapper.selectStatisticsWithF21MonthlyByExample(example);
    }
