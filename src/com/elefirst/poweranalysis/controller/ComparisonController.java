...
public class ComparisonController extends BaseController {
    ...
    @RequestMapping(value = "/electricity/yearly/rateseq/all/chart.do")
    @ApiOperation(value = "图表", notes = "", httpMethod = "POST")
    @ResponseBody
    public ErrorMsg getElectricityYearlyRateSeqChartAll(HttpServletRequest request,
                                                         HttpServletResponse response,
                                                         @RequestBody String sData
    ) {
        JSONObject jParam = JSONObject.fromObject(sData);
        ...
        List<PowerAnalysisElectricityYearlyRateSeqChartAllF33> list = powerAnalysisService.getElectricityYearlyRateSeqChartAll(param);
