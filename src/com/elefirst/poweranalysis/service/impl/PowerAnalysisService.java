...
public class PowerAnalysisService extends BaseService implements IPowerAnalysisService {
    ...
    public List<PowerAnalysisElectricityDailyChartIntervalDayF33> getElectricityDailyChartIntervalDay(Map<String, Object> param) {
        return powerAnalysisDAO.getElectricityDailyChartIntervalDay(param);
    }
    ...
    public List<PowerAnalysisElectricityMonthlyRateSeqChartAllF33> getElectricityMonthlyRateSeqChartAll(Map<String, Object> param) {
        return powerAnalysisDAO.getElectricityMonthlyRateSeqChartAll(param);
    }

    @Override
    public List<PowerAnalysisElectricityYearlyRateSeqChartAllF33> getElectricityYearlyRateSeqChartAll(Map<String, Object> param) {
        return powerAnalysisDAO.getElectricityYearlyRateSeqChartAll(param);
    }
