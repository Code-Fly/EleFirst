...
public class ReportT037Controller extends BaseController {
    ...
    public ErrorMsg getDailyList(HttpServletRequest request,
        ...
        for (int i = 0; i < pnInfos.size(); i++) {
            ...
            for (int j = 0; j < days.length; j++) {
                ...
                DataF105 dataF105 = getDataF105(dataF105s, pnInfo.getAreaId(), pnInfo.getConcentratorId(), pnInfo.getPn(), days[j]);
    ...
    private DataF105 getDataF105(List<DataF105> list, String areaId, String concentratorId, String pn, String date) {
