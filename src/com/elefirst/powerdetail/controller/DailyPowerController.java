...
public class DailyPowerController {
	private static final Logger logger = LoggerFactory
			.getLogger(DailyPowerController.class);
	...
	public @ResponseBody ErrorMsg queryDailyLoad(String date, String page,
	...
	public @ResponseBody ErrorMsg queryDailyVoltage(String date, String page,
			String rows, String jasonStr) throws Exception {
		DataGrid dg = new DataGrid();
		GeneralMessage gm = new GeneralMessage();
		List<String> ctrIds = new ArrayList<String>();
	...
	public @ResponseBody ErrorMsg queryDailyCurrent(String date, String page,
			String rows, String jasonStr) throws Exception {
		DataGrid dg = new DataGrid();
		GeneralMessage gm = new GeneralMessage();
		List<String> ctrIds = new ArrayList<String>();
	...
	public @ResponseBody ErrorMsg queryDailyPowerFactor(String date,
	...
	public @ResponseBody ErrorMsg queryDailyElectricity(String date,
			String page, String rows, String jasonStr) throws Exception {
		DataGrid dg = new DataGrid();
		GeneralMessage gm = new GeneralMessage();
		List<String> ctrIds = new ArrayList<String>();
	...
	public @ResponseBody ErrorMsg queryDailyPartionHarmonic(String date,
			String page, String rows, String jasonStr, String harmonicseq)
			throws Exception {
		DataGrid dg = new DataGrid();
		GeneralMessage gm = new GeneralMessage();
		List<String> ctrIds = new ArrayList<String>();
	 ...
	 * @throws Exception
	 */
	@RequestMapping("listDailyAllHarmonicBypn.do")
	public @ResponseBody ErrorMsg queryDailyAllHarmonicBypn(String page,
			String rows, String areaId, String concentratorId, String pn,
	...
	public @ResponseBody ErrorMsg queryDailyDisPlay(String date, String page,
			String rows, String jasonStr) throws Exception {
		DataGrid dg = new DataGrid();
		GeneralMessage gm = new GeneralMessage();
		List<String> ctrIds = new ArrayList<String>();
	...
	public @ResponseBody ErrorMsg queryAllDailyPower(String tabName,
	...
	private void setTotalActivePowerDetail(String areaId,
		...
		DailyLoad dailyload = dailyPowerServiceImpl.fetchSingleDailyLoad(date,
				areaId, concentratorId, pn);
		// 最大负荷
		...
		paramMap.put(
				...
				com.elefirst.base.utils.DateUtil.StringPattern(
						dailyload.getDays(), "yyyyMMdd", "yyyy-MM-dd"));
		...
		double peakValleyDifference = Arith.sub(dailyload.getMaxactivepower(),
				dailyload.getMinactivepower());
	...
	private void setPowerFactorDetail(String areaId, String concentratorId,
			String pn, Map<String, String> paramMap, String date)
			throws Exception {
		DailyPowerFactor dailyPowerFactor = dailyPowerServiceImpl
				.fetchSingleDailyPowerFactor(date, areaId, concentratorId, pn);
		paramMap.put("maxAPowerFactor", dailyPowerFactor.getAmaxpowerfactor()
				+ "");
		paramMap.put(
				"maxAPowerFactorTime",
				com.elefirst.base.utils.DateUtil.StringPattern(
						dailyPowerFactor.getDays(), "yyyyMMdd", "yyyy-MM-dd"));
		...
		paramMap.put("maxTotalPowerFactor",
				dailyPowerFactor.getMaxtotalpowerfactor() + "");
		paramMap.put(
				"maxTotalPowerFactorTime",
				com.elefirst.base.utils.DateUtil.StringPattern(
						dailyPowerFactor.getDays(), "yyyyMMdd", "yyyy-MM-dd"));
		...
		paramMap.put("minTotalPowerFactor",
				dailyPowerFactor.getMintotalpowerfactor() + "");
		paramMap.put(
				"minTotalPowerFactorTime",
				com.elefirst.base.utils.DateUtil.StringPattern(
						dailyPowerFactor.getDays(), "yyyyMMdd", "yyyy-MM-dd"));
	...
	private void setCurrentDetail(String areaId, String concentratorId,
			String pn, Map<String, String> paramMap, String date)
			throws Exception {
		DailyCurrent dailyCurrent = dailyPowerServiceImpl
				.fetchSingleDailyCurrent(date, areaId, concentratorId, pn);

		paramMap.put("maxACurrent", dailyCurrent.getMaxacurrent() + "");
		paramMap.put(
				"maxACurrentTime",
				com.elefirst.base.utils.DateUtil.StringPattern(
						dailyCurrent.getDays(), "yyyyMMdd", "yyyy-MM-dd"));
	...
	private void setVoltageDetail(String areaId, String concentratorId,
			String pn, Map<String, String> paramMap, String date)
			throws Exception {
		DailyVoltage dailyVoltage = dailyPowerServiceImpl.fetchSingleVoltage(
		...
		paramMap.put(
				"maxAVoltageTime",
				com.elefirst.base.utils.DateUtil.StringPattern(
						dailyVoltage.getDays(), "yyyyMMdd", "yyyy-MM-dd"));
